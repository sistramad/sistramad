...
DocumentMaster.new(name: "Cédula de Identidad", code: "CI", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "RIF", code: "RIF", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Carta de Aceptación", code: "CAC", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Utimo ascenso", code: "UAS", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Sintesis curricular", code: "SCU", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Solvencia Biblioteca", code: "SBI", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Solvencia DAE", code: "SDAE", procedure: "Año Sabatico", active: true ).save
DocumentMaster.new(name: "Certificado de idioma", code: "CID", procedure: "Año Sabatico", active: true ).save
