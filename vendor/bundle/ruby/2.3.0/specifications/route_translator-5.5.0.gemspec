# -*- encoding: utf-8 -*-
# stub: route_translator 5.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>, ["< 5.2", ">= 5.0.0.1"])
      s.add_runtime_dependency(%q<actionpack>, ["< 5.2", ">= 5.0.0.1"])
      ...
      s.add_development_dependency(%q<rails>, ["< 5.2", ">= 5.0.0.1"])
      s.add_development_dependency(%q<rake>, ["~> 12.0"])
      s.add_development_dependency(%q<rubocop>, ["~> 0.49.1"])
      s.add_development_dependency(%q<simplecov>, ["~> 0.14.1"])
    else
      s.add_dependency(%q<activesupport>, ["< 5.2", ">= 5.0.0.1"])
      s.add_dependency(%q<actionpack>, ["< 5.2", ">= 5.0.0.1"])
