    ...
    Plugin.prototype =
    {
        ...
        constructHTMLCalendar: function (date, calendar)
        {
            ...
            for (var i = 0; i < calendar.days.length; i++)
            {
                ...
                var m = moment(calendar.days[i]).locale(this.params.lang)
                if (moment(m).isBefore((this.currentDate).locale(this.params.lang))) {

                    _template += '<td class="not-active" data-date="' + moment(calendar.days[i]).locale(this.params.lang).format("D") + '">';
                }else{
